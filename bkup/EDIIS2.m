classdef EDIIS < handle
    ...
    methods
        ...
        function obj = EDIIS(oeiVector, type, numVectors)
            ...
            obj.elecEnergies = zeros(numVectors, 1);
        end
        ...
        function Push(obj, newFockVector, newDensVector, newElecEnergy)
            ...
            % push new energy in
            obj.energies(1:end-1) = obj.elecEnergies(2:end);
